...
import { motion } from "framer-motion"
import { Crown, Rocket, Shield, Clock, Zap, Users, Package, Target } from "lucide-react"
...
const benefits = [
  ...
  },
  {
    ...
    description: "Stop running around & coordinating with different production departments.",
  },
  {
    icon: Users,
    title: "Professional Team",
    description: "Work with experienced professionals & single point contact for all your needs.",
  },
  {
    icon: Package,
    title: "Single Orders Welcome",
    description: "We gladly welcome customer orders of any size, from single pieces to bulk.",
  },
  {
    icon: Target,
    title: "Start to Finish",
    description: "Ensuring uniform quality & maintaining consistency throughout the process.",
  },
  {
    icon: Shield,
    title: "On Time Delivery",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-3 space-y-4">
            {benefits.slice(0, 4).map((benefit, index) => (
              <motion.div
                key={index}
                className="cursor-pointer group relative p-5 bg-white border-2 border-gray-100 rounded-2xl shadow-lg hover:shadow-2xl hover:border-black/20 transition-all duration-500"
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: false }}
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-10 h-10 bg-black rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
          ...
          {/* Center Image Section - 4 Images */}
          <div className="lg:col-span-6 hidden justify-center lg:flex">
            <motion.div
            ...
            >
              ...
              {/* Top Left Image – move higher */}
              <motion.div
                className="cursor-pointer absolute -top-15 left-0 w-3/5 h-2/5 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80"
              ...
              {/* Top Right Image – keep as is */}
              <motion.div
                className="cursor-pointer absolute top-20 right-0 w-3/5 h-2/5 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80"
                whileHover={{ scale: 1.05, rotate: -2, zIndex: 50 }}
                transition={{ duration: 0.3 }}
              >
                <img
              ...
              {/* Bottom Left Image – keep as is */}
              <motion.div
                className="cursor-pointer absolute bottom-10 left-0 w-3/5 h-2/5 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80"
              ...
              {/* Bottom Right Image – move more down */}
              <motion.div
                className="cursor-pointer absolute -bottom-22 right-0 w-3/5 h-2/5 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80"
                whileHover={{ scale: 1.05, rotate: -1, zIndex: 50 }}
                transition={{ duration: 0.3 }}
              >
                <img
          ...
          <div className="lg:col-span-6 flex lg:hidden justify-center ">
            <motion.div
              className="relative w-full max-w-lg h-96 lg:h-[500px] grid grid-cols-2 gap-4 lg:grid-cols-none"
              initial={{ opacity: 0, scale: 0.8 }}
              whileInView={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: false }}
            >
              {/* Top Left Image */}
              <motion.div
                className="cursor-pointer w-full h-40 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80 lg:absolute lg:-top-15 lg:left-0"
                whileHover={{ scale: 1.05, rotate: 2, zIndex: 50 }}
                transition={{ duration: 0.3 }}
              >
                <img
              ...
              {/* Top Right Image */}
              <motion.div
                className="cursor-pointer w-full h-40 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80 lg:absolute lg:top-20 lg:right-0"
                whileHover={{ scale: 1.05, rotate: -2, zIndex: 50 }}
                transition={{ duration: 0.3 }}
              >
                <img
              ...
              {/* Bottom Left Image */}
              <motion.div
                className="cursor-pointer w-full h-40 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80 lg:absolute lg:bottom-10 lg:left-0"
                whileHover={{ scale: 1.05, rotate: 1, zIndex: 50 }}
                transition={{ duration: 0.3 }}
              >
                <img
              ...
              {/* Bottom Right Image */}
              <motion.div
                className="cursor-pointer w-full h-40 rounded-3xl overflow-hidden shadow-2xl border-4 border-black/80 lg:absolute lg:-bottom-22 lg:right-0"
                whileHover={{ scale: 1.05, rotate: -1, zIndex: 50 }}
                transition={{ duration: 0.3 }}
              >
                <img
